    ...
    render() {
        ...
        return (
            <div className=" flex flex-row flex-grow min-h-full text-center">
                <div className=" flex-2 bg-green-500 max-w-3/7 w-full hidden lg:inline-block">
                ...
                <div className="flex-4 min-h-full inline-block">
                    <WindowClose color="text-purple-700"/>
                    <h1 className="text-2xl pt-20 pb-10">Login</h1>
                    <GoogleButton displayText="Log In" url="/login" color="bg-purple-700"/>
                    <OrSeparator />
                    <LoginForm />
                </div>
            </div>
